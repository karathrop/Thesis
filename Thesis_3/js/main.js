...
$(document).ready(function(){
		var socket = io.connect('http://kcl389.itp.io:8875');
		...
		socket.on('sensor', function(data) {
			console.log("HELLO");
				...
				if (data == 0) {
					...
					rightBrickSpecial.pause();
					rightBrickVideo.style.display="none";
					rightBrickSpecial.style.display="none";
					rightBrickSpecial.currentTime = 0;
					...
					console.log("spcial video plays");
					rightBrickSpecial.play();
					rightBrickVideo.pause();
					rightBrickSpecial.style.display="block";	
					rightBrickVideo.style.display="none";
				}
